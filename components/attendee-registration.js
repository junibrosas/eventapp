				...
				<div className="container marginbot-50">
					<div className="row">
						<div className="col-lg-8 col-lg-offset-2 text-center">
							<div className="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
						
								<h2 className="h-bold">Hi, { this.state.attendee.name }</h2>
			...
			<div id="content-page-one">
				<div className="container marginbot-50">
					<div className="row">
						<div className="col-lg-8 col-lg-offset-2 text-center">
							<div className="wow flipInY" data-wow-offset="0" data-wow-delay="0.4s">
								<h2 className="h-bold">Event Name</h2>
